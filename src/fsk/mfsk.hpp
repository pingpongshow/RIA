...
// Fast test mode: shorter symbols for quicker testing
// Uses 512 samples/symbol (10.7ms) instead of 1536 (32ms)
// ~470 bps raw, ~235 bps with R1/2 LDPC
// Requires SNR > 5 dB
inline MFSKConfig test_fast() {
    MFSKConfig cfg;
    cfg.num_tones = 32;
